...
#     oil_df = commodity_df[['date', 'oil_brent', 'oil_dubai']]
...
#     color = 'tab:blue'
#     ax1.set_xlabel('Year')
#     ax1.set_ylabel('Price of oil_brent and oil_dubai', color=color)
#     ax1.plot(merged_df['year'], merged_df['oil_brent'], color=color, label='Price of oil_brent')
#     ax1.plot(merged_df['year'], merged_df['oil_dubai'], color='tab:green', label='Price of oil_dubai')
#     ax1.tick_params(axis='y', labelcolor=color)

#     ax2 = ax1.twinx()
#     color = 'tab:red'
#     ax2.set_ylabel('Number of Attacks', color=color)
#     ax2.scatter(merged_df['year'], merged_df['attack_count'], color=color, label='Number of Attacks')
