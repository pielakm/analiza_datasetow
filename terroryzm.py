...
#
# # Load the dataset
# data = pd.read_csv('globalterrorismdb_filtered.csv', encoding='ISO-8859-1')
#
# # Extract year and count the number of attacks per year
