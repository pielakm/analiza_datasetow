...
plt.scatter(merged_data.index, merged_data['attacks'], label='Number of Attacks', color='blue')

# Plot oil prices as scatter plot
plt.scatter(merged_data.index, merged_data['oil_price'], label='Dubai Oil Price', color='orange')
